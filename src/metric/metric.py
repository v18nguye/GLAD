...
class PlanarMetric(SpectreSamplingMetric):
    def __init__(self, train_loader, test_loader):
        super(PlanarMetric, self).__init__(train_loader, test_loader,
                         compute_emd=True,
                         metrics_list=['degree', 'clustering', 'orbit', 'spectre', 'planar'])


class SBMMetric(SpectreSamplingMetric):
    def __init__(self, train_loader, test_loader):
        super(SBMMetric, self).__init__(train_loader, test_loader,
                         compute_emd=True,
