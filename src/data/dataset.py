...
# ref: https://pytorch-geometric.readthedocs.io/en/latest/tutorial/create_dataset.html
# ref: https://github.com/pyg-team/pytorch_geometric/discussions/4132
...
class GraphDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        if self.datset in ['community', 'ego', 'grid', 'ENZYMES']:
